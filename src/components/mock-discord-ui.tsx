...
export const MockDiscordUI = ({ children }: PropsWithChildren) => {
  return (
    <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-background overflow-hidden rounded-lg shadow-xl">
      <div className="hidden sm:flex w-[72px] bg-[#202225] py-3 flex-col items-center">
        <div
          className=" size-12 bg-discord-brand-color rounded-2xl
             flex items-center justify-center mb-2 hover:rounded-xl transition-all duration-200"
        >
        ...
        {[...Array(5)].map((_, i) => (
          <div
            key={i}
            className="size-12 bg-discord-background rounded-3xl flex items-center justify-center mb-3 hover:rounded-xl duration-200 hover:bg-discord-brand-color transition-all cursor-not-allowed"
          >
        ...
        <div className="group mt-auto size-12 bg-discord-background rounded-3xl flex items-center justify-center mb-3 hover:rounded-xl duration-200 hover:bg-[#3ba55c] transition-all cursor-not-allowed">
        ...
        <div className="flex-1 overflow-y-auto pt-4">
          <div className="px-2 mb-4">
            <div className="flex items-center text-sm px-2 py-1.5 rounded hover:bg-[#393c43] text-[#dcddde]cursor-not-allowed">
              ...
              <span className="font-medium text-sm text-[#b9bbbe] ">
                Friends
              </span>
            </div>
            <div className="flex items-center text-sm px-2 py-1.5 rounded hover:bg-[#393c43] text-[#dcddde]cursor-not-allowed">
              <Inbox className="mr-4 size-8 text-[#b9bbbe]" />
              <span className="font-medium text-sm text-[#b9bbbe] ">Nitro</span>
            </div>
          </div>
          <div className="px-2 mb-4">
            ...
            <div className="flex items-center px-2 py-1.5 rounded bg-[#393c43] text-white cursor-pointer">
              <Image
                ...
                width={32}
                height={32}
                className="object-cover scale-150 rounded-full mr-3"
              />
              <span className="font-medium">PingTiger</span>
            </div>
          ...
          <div className="flex items-center">
            <div className="relative">
              <Image
                ...
                width={40}
                height={40}
                className="object-cover rounded-full mr-3 scale-150"
              />
              <div className="absolute bottom-0 rounded-full bg-gray-500 right-3 size-3 border-2 border-[#36393f]" />
            </div>
            <p className="font-semibold text-white">PingTiger</p>
          </div>
